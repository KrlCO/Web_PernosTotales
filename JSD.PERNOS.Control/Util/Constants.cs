namespace JSD.SUNKU.Control.Util
{
    public class Constants
    {
        ...
        {
            public static string CacheTiempoVida = "CacheTiempoVida";
            public static string TokenClave = "TokenClave";
            public static string TokenMinutos = "TokenMinutos";
            public static string TiempoVidaCodigoVerificacion = "TiempoVidaCodigoVerificacion";
        }

        public static class ConstantesUsuario
        {
            public const string IdUser = "IdUser";
            public const string IdPersona = "IdPersona";
            public const string TipoUser = "TipoUser";
        ...
        {
            public static string IdentificadorUnico = "IdentificadorUnico";
        }
